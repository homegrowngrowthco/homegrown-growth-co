...
Shares auth with theautomationsguide/gsc-index-status.py — OAuth *user*
...
Usage:
  C:\\Users\\Ian\\.venvs\\gsc\\Scripts\\python scripts/gsc-index-status.py [host]
  host defaults to https://homegrowngrowth.co
"""
import os
import sys
...
HOST = (sys.argv[1] if len(sys.argv) > 1 else "https://homegrowngrowth.co").rstrip("/")
BARE = HOST.split("://", 1)[-1]
